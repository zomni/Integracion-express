...
router.patch(
  "/despacho/actualizardespacho/:id",
  proxyController.reenviarPeticion
);
...
router.patch(
  "/inventario/actualizarInventario/:id",
  proxyController.reenviarPeticion
);
...
router.get("/pedido/:id/pdf", proxyController.reenviarPeticion);
